...
- **Primary DNS**: `45.8.125.44`
- **Secondary DNS**: `185.125.168.124`
...
Add forwarder:
- Server IP: `45.8.125.44`, Forward TLS Upstream, Verify CN: `dns.hydrabrowser.net`
- Server IP: `185.125.168.124`, same as above
...
```
/ip dns set servers=45.8.125.44,185.125.168.124 allow-remote-requests=yes
```
...
1. Primary DNS server: `45.8.125.44`
2. Secondary DNS server: `185.125.168.124`
